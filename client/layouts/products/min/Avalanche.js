    ...
    return (
        <Fragment>
            <List>
                ...
                <Entry term="Avalanche time">{avalancheOccurrenceTime}</Entry>
                ...
                <Entry term="Avalanche character">{avalancheCharacter}</Entry>
                ...
                <Entry term="Crust near weak layer">{crustNearWeakLayer}</Entry>
