...
function getButton(options) {
    return (
        <button
            key={options.key}
            className={`ui basic button button-${options.type}`}
...
function create(overrides = {}) {
    ...
    list.renderRowWithoutButtons =
        overrides.renderRowWithoutButtons ||
        function renderRowWithoutButtons(item /* , locals*/) {
            return (
    ...
    list.renderRowButton =
        overrides.renderRowButton ||
    ...
    list.renderButtonGroup =
        overrides.renderButtonGroup ||
        function renderButtonGroup(buttons /* , locals*/) {
            return (
    ...
    list.renderAddButton =
        overrides.renderAddButton ||
