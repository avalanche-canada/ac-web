...
const Nadine = {
    ...
    banner: {
        src:
            'https://prismic-io.s3.amazonaws.com/avalancheca/83492140d84e2fd7bfbf252ddd3f15024c024709_img_9701timgrey.jpg',
    },
    avatar: {
        src:
            'https://prismic-io.s3.amazonaws.com/avalancheca/0838a27309f5d9edd8d521bcfbe733525665c5be_nadine-head-shot-av-am.jpg',
    },
    socials: [
...
stories.add('Ambassador', () => {
    ...
    return <Ambassador {...props}>{biography}</Ambassador>
})
