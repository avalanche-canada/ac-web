...
const LOW = (
    <g width="81.62" height="81.62">
        ...
        <path fill={Palette.WHITE} d="M68.9 29.8l-4.84-4.84L48.9 9.76 43.7 4.6l-1.54-1.55-.97-.98c-.1-.1-.3-.16-.4-.16-.18 0-.3.1-.4.2l-.74.76L17.53 25l12.63-7.18 9.24 4.33 10.1-7.83.44.33L67 31.7c.52.53 1.37.53 1.9 0 .53-.52.53-1.37 0-1.9z" />
        <path fill={Palette.GREEN} d="M2.1 41.1l38.34 38.33c.1.1.22.15.36.15.13 0 .26-.06.35-.15L79.5 41.1c.08-.1.12-.2.13-.32H1.97c0 .12.05.23.14.32z" />
...
const MODERATE = (
    <g width="81.62" height="81.61">
        ...
        <path fill={Palette.YELLOW} d="M2.1 41.1l38.34 38.33c.1.1.23.15.36.15.13 0 .26-.05.36-.15L79.5 41.1c.08-.1.12-.2.13-.32H1.97c0 .12.06.23.14.32z" />
        ...
        <path fill={Palette.WHITE} d="M69.33 34.05c-.9-.9-1.4-2.1-1.44-3.4l-.1-.34h-.4c-.7-.1-1.3-.5-1.8-1-.3-.2-.4-.5-.6-.7l-.1-.1h-.2c-.3-.1-.6-.3-.84-.6-.6-.6-.95-1.5-.9-2.4l.06-.43-.5-.04c-.8-.07-1.6-.4-2.2-1-1.32-1.3-1.32-3.46 0-4.8 1.3-1.3 3.46-1.3 4.8 0 .28.3.5.65.68 1.03l.3.6.57-.6.1-.07c1.5-1.5 3.96-1.5 5.46 0 1.35 1.3 1.5 3.4.45 4.9l-.45.7.8.05c1.15.1 2.26.6 3.1 1.45 1.9 1.92 1.9 5.05 0 7-1.94 1.9-5.07 1.9-7 0z" />
        <path fill={Palette.WHITE} d="M71.27 32.16l-7.2-7.2-15.2-15.2L43.7 4.6l-1.55-1.54-.98-1c-.1-.08-.24-.14-.37-.14-.14 0-.27.06-.37.15l-.73.74L17.52 25l12.64-7.17 9.23 4.36 10-7.9.4.3L69.3 34c.5.52 1.34.52 1.9 0 .5-.54.5-1.4 0-1.93z" />
...
const CONSIDERABLE = (
    <g width="98.38" height="81.61">
        ...
        <path fill={Palette.ORANGE} d="M2.1 41.1l38.34 38.33c.1.1.22.15.36.15.13 0 .26-.05.36-.15L79.5 41.1c.08-.1.12-.2.13-.32H1.97c0 .1.05.23.14.32z" />
        <g fill="#010101">
...
const HIGH = (
    <g width="113.31" height="81.62">
        ...
        <path fill={Palette.RED} d="M2.1 41.1l38.34 38.33c.1.1.23.15.36.15.13 0 .26-.05.36-.15L79.5 41.1c.08-.1.12-.2.13-.32H1.97c0 .12.06.23.14.32z" />
...
export default new Map([
    ...
    [Ratings.CONSIDERABLE, CONSIDERABLE],
    [Ratings.HIGH, HIGH],
    [Ratings.EXTREME, HIGH],
    [Ratings.NO_RATING, NO_RATING],
])
