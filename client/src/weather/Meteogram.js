...
import { compose, pure, mapProps, setPropTypes, setDisplayName } from 'recompose'
...
function convertProps({ model, run, location }) {
    ...
    return {
        url: `${DOMAIN}/cac/products/${prefix}.${run}Z_${location}.png`,
        openNewTab: true,
    }
