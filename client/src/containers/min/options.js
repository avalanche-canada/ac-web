...
import {observation, observationSet, layout} from './templates'
...
export default {
    ...
    fields: {
        ...
        observations: {
            ...
            legend: 'Step 3. Observations',
            help: 'Add information on one, some, or all tabs, then click SUBMIT at the bottom.',
            fields: {
                [QUICK]: {
