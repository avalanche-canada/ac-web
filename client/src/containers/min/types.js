...
const Quick = t.struct({
    ...
    avalancheConditions: t.maybe(createBooleanStruct(AvalancheConditionsOptions)),
    comment: t.maybe(t.String),
})

const AvalancheCharacterOptions = ['Storm slab', 'Wind slab', 'Persistent slab', 'Deep persistent slab', 'Wet slab', 'Cornice only', 'Cornice with slab', 'Loose wet', 'Loose dry']
...
const Avalanche = t.struct({
    ...
    weakLayerCrystalType: t.maybe(createBooleanStruct(WeakLayerCrystalTypeOptions)),
...
const SnowpackSurfaceConditionOptions = ['New snow', 'Crust', 'Surface hoar', 'Facets', 'Corn', 'Variable']
const SnowpackTestFailureLayerCrystalTypeOptions = ['Surface hoar', 'Facets', 'Depth hoar', 'Storm snow', 'Crust', 'Other']
...
const Snowpack = t.struct({
    ...
    snowpackSiteElevationBand: t.maybe(createBooleanStruct(ElevationBandOptions)),
    ...
    snowpackSurfaceCondition: t.maybe(createBooleanStruct(SnowpackSurfaceConditionOptions)),
    ...
    snowpackTestFailureLayerCrystalType: t.maybe(createBooleanStruct(SnowpackTestFailureLayerCrystalTypeOptions)),
...
const TerrainTrapOptions = ['No obvious terrain trap', 'Gully or depression', 'Slope transition or bench', 'Trees', 'Cliff']
...
const ObservationSet = t.subtype(t.struct({
    [QUICK]: t.maybe(Quick),
