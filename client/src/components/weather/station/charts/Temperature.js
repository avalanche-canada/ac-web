...
import {VictoryLine, VictoryChart, VictoryScatter, VictoryAxis, VictoryContainer} from 'victory'
...
export default function Temperature({data, min, max, width, height}) {
    ...
    return (
        <VictoryChart width={width} height={height} theme={theme} domainPadding={25}>
            ...
            <VictoryScatter data={data} x='measurementDateTime' y='airTempMin' style={STYLE.min.scatter} />
            <VictoryScatter data={data} x='measurementDateTime' y='airTempMax' style={STYLE.max.scatter} />
            <VictoryScatter data={data} x='measurementDateTime' y='airTempAvg' style={STYLE.avg.scatter} />
        </VictoryChart>
    )
}
